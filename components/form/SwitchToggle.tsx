...
const SwitchToggle = forwardRef(function SwitchToggle(
	{ title, checked, changeHandler, id, className }: Props,
	...
	return (
		<div className="flex items-center">
			...
			/>
			<label
				className="inline-block pl-[0.5rem] hover:cursor-pointer text-base font-bold"
				htmlFor="flexSwitchCheckDefault"
			>
				{checked ? title[0] : title[1]}
			</label>
		</div>
	);
});
